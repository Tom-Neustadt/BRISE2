    ...
    def run(self):
        ...
        if not self.experiment_setup:
            ...
            if len(argv) > 1:
                ...
                exp_desc_file_path = './Resources/self_testing/selftesting_instance.json'
...
if __name__ == "__main__":
    ...
    ##os.environ["BRISE_EVENT_SERVICE_HOST"] = "127.0.0.1"
    ...
    ##os.environ["BRISE_DATABASE_HOST"] = "127.0.0.1"
