...
from configuration_selection.model.configuration_transformer.binary_transformer import BinaryTransformer
...
class SklearnBinaryTransformer(BinaryTransformer):
